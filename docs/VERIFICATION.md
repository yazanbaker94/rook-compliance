...
- API unit tests: 7/7 passed, including duplicate-safe mobile sync, proposal review, imported-facility retention, obligation creation, audit events, and evidence approval.
